...
for grupo in combinations(pessoas, 2):
    ...
    Ou seja, se ('Luiz', 'Andre') existe, a ordem ('Andre', 'Luiz') não existirá, visto que é como se fosse a mesma coisa.
    """
    print(grupo)
...
for grupo in permutations(pessoas, 2):
    ...
    Ou seja, se ('Luiz', 'Andre') existe, a ordem ('Andre', 'Luiz') EXISTIRÁ também, visto que são diferentes quando levamos em consideração a ordem.
    """
    print(grupo)
